...
MAAND2INT = {'January':1,'February':2, 'March':3, 'April':4, 'May':5, 'June':6, 'July':7, 'August':8, 'September':9, 'October':10, 'November':11, 'December':12,
             ...
             'september': 9, 'october': 10, 'november': 11, 'december': 12, 'januari': 1, 'februari': 2, 'maart' : 3, 'april': 4, 'mei': 5, 'juni': 6, 'juli': 7,
...
class asn(Scraper):
    ...
    def get(self):
        ...
        for link in links:
            ...
            try:
                title = "".join(tree.xpath('//*[@class="h1-wrapper"]/h1//text()')).strip()
            except:
                #print("no title")
                title = ""
            try:
            ...
            try:
                text = "".join(tree.xpath('//*[@class="article-default"]//text()')).strip()
            except:
                #print("geen text")
