...
class danishparliament(Scraper):
    ...
    def process_version1(self, tree, releases, link, category):
        ...
        try:
            ...
            text = ""
        try:
            pdf_url="".join(tree.xpath('//*[@id="ContentArea"]/div[5]/div[6]/div/div/div/div/table/tr/td[2]/table/tr/td[2]/a[1]/@href')).strip()
    ...
    def process_version2(self, tree, releases, link, category):
        ...
        try:
            ...
            for row in rows:
                row_text = "".join(row.xpath('div[@class="col-sm-12"]/div/div/div/table/tr/td/p//text()')).strip()
        ...
        text = "".join(text)
        try:
            pdf_url="".join(tree.xpath('//*[@id="ContentArea"]/div[5]/div[7]/div/div/div/div/table/tr/td[2]/table/tr/td[2]/a[1]/@href')).strip()
            self.create_pdf(pdf_url)
        except:
            pdf_url= ""
            pdf_url_clean = " ".join(pdf_url.split())
