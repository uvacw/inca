...
#title
        try:
            title = ''.join(tree.xpath('//*[@class="atc-Header"]/div/h2/span/text()|//*[@class="atc-Header"]/div/h2/span/span/text()|//*[@class="atc-Header atc-Header-comment"]/div/div/h2/span/span/text()|//*[@class="atc-Header atc-Header-comment"]/div/div/h2/span/text() ')).replace('\n','').replace('\t','')
        except:
            title =""
...
#Text:
        try:
            text = ' '.join(tree.xpath('//*[@class="atc-Text "]/p/text()|//*[@class="atc-Text "]/p/a/text()'))
