    ...
    def parsehtml(self, htmlsource):
        ...
        try:
            ...
            if typenews == [] or typenews == "":
                ...
                try:
                    textfirstpara = (
                        " ".join(
                            tree.xpath(
                                '//*[@class="intro"]/text() | //*[@class="intro"]/em/text()'
                            )
                        )
                        .replace("\n", "")
                        .strip()
                ...
                try:
                    textrest = " ".join(
                        tree.xpath(
                            '//*[@class="clear"]/p/text() | //*[@class="clear"]/p/strong/text() | //*[@class="clear"]/p/em/text() | //*[@class="clear"]/h3/text() | //*[@class="clear"]/p/a/text() | //*[@class="clear"]/p/em/text()'
                        )
                    )
                except:
            ...
            # for regional news
                ...
                try:
                    textfirstpara = (
                        " ".join(tree.xpath('//*[@class="article__intro"]/text()'))
                        .replace("\n", "")
                        .strip()
                    )
                except:
                ...
                try:
                    textrest = " ".join(
                        tree.xpath(
                            '//*[@class="article__body__container"]/h3/text() | //*[@class="article__body__container"]/p/text()'
                        )
                    ).strip()
                except:
                    logger.warning("Could not parse article text")
